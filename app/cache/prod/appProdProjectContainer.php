...
class appProdProjectContainer extends Container
{
    ...
    {
        return $this->services['annotation_reader'] = new \Doctrine\Common\Annotations\FileCacheReader(new \Doctrine\Common\Annotations\AnnotationReader(), '/var/www/Hangman/app/cache/prod/annotations', false);
    }
    ...
    {
        return $this->services['doctrine.dbal.default_connection'] = $this->get('doctrine.dbal.connection_factory')->createConnection(array('dbname' => 'hangman', 'host' => 'localhost', 'port' => NULL, 'user' => 'root', 'password' => 'oko', 'charset' => 'UTF8', 'driver' => 'pdo_mysql', 'driverOptions' => array()), new \Doctrine\DBAL\Configuration(), new \Symfony\Bridge\Doctrine\ContainerAwareEventManager($this), array());
    }
    protected function getDoctrine_Orm_DefaultEntityManagerService()
    {
        require_once '/var/www/Hangman/app/cache/prod/jms_diextra/doctrine/EntityManager_50b6057977d7a.php';
        $a = new \Doctrine\Common\Cache\ArrayCache();
        $a->setNamespace('sf2orm_default_0bf5afb7387cc4472146650494981f1e');
        $b = new \Doctrine\Common\Cache\ArrayCache();
        $b->setNamespace('sf2orm_default_0bf5afb7387cc4472146650494981f1e');
        $c = new \Doctrine\Common\Cache\ArrayCache();
        $c->setNamespace('sf2orm_default_0bf5afb7387cc4472146650494981f1e');
        ...
        $e->setProxyDir('/var/www/Hangman/app/cache/prod/doctrine/orm/Proxies');
        ...
        return $this->services['doctrine.orm.default_entity_manager'] = new \EntityManager50b6057977d7a_546a8d27f194334ee012bfe64f629947b07e4919\__CG__\Doctrine\ORM\EntityManager($f, $this);
    }
    ...
    protected function getJmsDiExtra_Metadata_MetadataFactoryService()
    {
        ...
        $instance->setCache(new \Metadata\Cache\FileCache('/var/www/Hangman/app/cache/prod/jms_diextra/metadata'));
        return $instance;
    }
    ...
    {
        return $this->services['monolog.handler.nested'] = new \Monolog\Handler\StreamHandler('/var/www/Hangman/app/logs/prod.log', 100, true);
    }
    ...
    {
        return $this->services['session.handler'] = new \Symfony\Component\HttpFoundation\Session\Storage\Handler\NativeFileSessionHandler('/var/www/Hangman/app/cache/prod/sessions');
    }
    protected function getSession_Storage_FilesystemService()
    {
        return $this->services['session.storage.filesystem'] = new \Symfony\Component\HttpFoundation\Session\Storage\MockFileSessionStorage('/var/www/Hangman/app/cache/prod/sessions');
    }
    ...
    protected function getTwigService()
    {
        ...
        $this->services['twig'] = $instance = new \Twig_Environment($this->get('twig.loader'), array('debug' => false, 'strict_variables' => false, 'exception_controller' => 'Symfony\\Bundle\\TwigBundle\\Controller\\ExceptionController::showAction', 'cache' => '/var/www/Hangman/app/cache/prod/twig', 'charset' => 'UTF-8', 'paths' => array()));
    ...
    {
        return $this->services['assetic.asset_factory'] = new \Symfony\Bundle\AsseticBundle\Factory\AssetFactory($this->get('kernel'), $this, $this->getParameterBag(), '/var/www/Hangman/app/../web', false);
    }
    ...
    protected function getSecurity_Access_DecisionManagerService()
    {
        ...
        $a->setCacheDir('/var/www/Hangman/app/cache/prod/jms_security/expressions');
    ...
    {
        return $this->services['templating.locator'] = new \Symfony\Bundle\FrameworkBundle\Templating\Loader\TemplateLocator($this->get('file_locator'), '/var/www/Hangman/app/cache/prod');
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.debug' => false,
            'kernel.name' => 'app',
            'kernel.cache_dir' => '/var/www/Hangman/app/cache/prod',
            ...
            'session.save_path' => '/var/www/Hangman/app/cache/prod/sessions',
            ...
            'router.resource' => '/var/www/Hangman/app/config/routing.yml',
            ...
            'twig.options' => array(
                ...
                'cache' => '/var/www/Hangman/app/cache/prod/twig',
                'charset' => 'UTF-8',
                'paths' => array(
                ),
            ),
            ...
            'swiftmailer.spool.memory.path' => '/var/www/Hangman/app/cache/prod/swiftmailer/spool',
            ...
            'assetic.cache_dir' => '/var/www/Hangman/app/cache/prod/assetic',
            ...
            'doctrine.orm.proxy_dir' => '/var/www/Hangman/app/cache/prod/doctrine/orm/Proxies',
            ...
            'jms_aop.cache_dir' => '/var/www/Hangman/app/cache/prod/jms_aop',
            ...
            'jms_di_extra.cache_dir' => '/var/www/Hangman/app/cache/prod/jms_diextra',
            'jms_di_extra.doctrine_integration' => true,
            'jms_di_extra.doctrine_integration.entity_manager.file' => '/var/www/Hangman/app/cache/prod/jms_diextra/doctrine/EntityManager_50b6057977d7a.php',
            'jms_di_extra.doctrine_integration.entity_manager.class' => 'EntityManager50b6057977d7a_546a8d27f194334ee012bfe64f629947b07e4919\\__CG__\\Doctrine\\ORM\\EntityManager',
            ...
            'security.extra.cache_dir' => '/var/www/Hangman/app/cache/prod/jms_security',
