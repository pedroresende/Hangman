...
class __TwigTemplate_bc3dea72129af986b7a219bb57058c69 extends Twig_Template
{
    ...
    <h2>Guess the mysterious word</h2>
        ...
        <p class=\"attempts\">
            You still have ";
        // line 14
        echo twig_escape_filter($this->env, $this->getAttribute((isset($context["game"]) ? $context["game"] : null), "remainingAttempts"), "html", null, true);
        ...
        $context['_seq'] = twig_ensure_traversable($this->getAttribute((isset($context["game"]) ? $context["game"] : null), "wordLetters"));
        foreach ($context['_seq'] as $context["_key"] => $context["letter"]) {
            // line 19
            echo "                <li class=\"letter ";
            echo (($this->getAttribute((isset($context["game"]) ? $context["game"] : null), "isLetterFound", array(0 => (isset($context["letter"]) ? $context["letter"] : null)), "method")) ? ("guessed") : ("hidden"));
            echo "\">
                    ";
            // line 20
            echo twig_escape_filter($this->env, (($this->getAttribute((isset($context["game"]) ? $context["game"] : null), "isLetterFound", array(0 => (isset($context["letter"]) ? $context["letter"] : null)), "method")) ? ((isset($context["letter"]) ? $context["letter"] : null)) : ("?")), "html", null, true);
            echo "
                </li>
            ";
        }
    ...
    <h2>Try a letter</h2>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["letter"]) {
            ...
            echo "                <li class=\"letter\">
                    <a href=\"";
            // line 38
            echo twig_escape_filter($this->env, $this->env->getExtension('routing')->getPath("play_letter", array("letter" => (isset($context["letter"]) ? $context["letter"] : null))), "html", null, true);
            echo "\">
                        ";
            // line 39
            echo twig_escape_filter($this->env, (isset($context["letter"]) ? $context["letter"] : null), "html", null, true);
            echo "
                    </a>
                </li>
            ";
